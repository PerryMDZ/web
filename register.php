    ...
    <div class="container">
        <div class="row justify-content-center ">
            <div class="col-xl-5 col-lg-6 col-md-8 border my-5 p-4 rounded mx-3">
                <h2 class="text-center text-white mt-2 mb-3 mb-3" >Create a new account</h2>
                <form method="post" action="" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <button type="submit" class="btn btn-danger px-5 mt-3 mr-2">Register</button>
                        <button type="reset" class="btn btn-outline-danger px-5 mt-3">Reset</button>
                    </div>
                    <div class="form-group">
                        <p style="color:aliceblue">Already have an account? <a href="login.php">Login</a> now.</p>
                    </div>
                </form>

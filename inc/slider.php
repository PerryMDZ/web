<section id="home" class="iq-main-slider p-0">
    <div id="home-slider" class="slider m-0 p-0" >
        <div class="slide slick-bg s-bg-1"style="background-image: url(images/slider/slider1.jpg)">
        <div class="container-fluid position-relative h-100">
            ...
            <div class="row align-items-center h--100">
                ...
                <p data-animation-in="fadeInUp">
                    In ancient times, there was a legend of man-eating demons that roamed the depths of the forest. Because of this, people in the village never go out in the dark. Legend also says that there is a Demon Slayer who always appears at night to destroy these bloodthirsty demons. For young Tanjiro, that folk tale has become the bitter reality he has to endure...
                </p>
                <div class="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                    <div class="text-primary title starring">
                    Starring :
                    <span class="text-body">Makoto Shinkai, Nanoka Hara, Eri Fukatsu</span>
                    </div>
                    ...
                    Tags :
                    <span class="text-body">Animation, Adventure, Horror</span>
                    </div>
                </div>
        ...
        <div class="container-fluid position-relative h-100">
            ...
            <div class="row align-items-center h--100">
                ...
                <p data-animation-in="fadeInUp">
                    The two main characters, Jake Sully and Neytiri, now a couple, vow to stay together. However, the two are forced to leave home and explore new lands on the moon Pandora, which is when the old dangers return to them.
                </p>
                <div class="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                    <div class="text-primary title starring">
                    Starring :
